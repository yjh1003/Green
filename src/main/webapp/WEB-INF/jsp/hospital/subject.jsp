...
<head>
<meta charset="UTF-8">
<title>Green - 리뷰 작성_진료과목 선택</title>
		...
		<div class="d-flex align-items-center">
		   <section class="d-flex">
               <nav>
               	...
               	<section class="subjectbox bg-primary containter">
               		
               			<div class="subjectselect bg-danger">
                                <a class="subjectselect-item" href="#">내과</a>
                                <a class="subjectselect-item" href="#">치과</a>
                                <a class="subjectselect-item" href="#">안과</a>
                                <a class="subjectselect-item" href="#">피부과</a>
                                <a class="subjectselect-item" href="#">이비인후과</a>                
               			</div>
